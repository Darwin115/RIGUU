...
function Tips_Elec() {
  ...
  const recommendations = {
    phone: [
      t("tips_elec.recommendations.phone.0"),
    ...
    laptop: [
      t("tips_elec.recommendations.laptop.0"),
    ...
    tablet: [
      t("tips_elec.recommendations.tablet.0"),
    ...
    television: [
      t("tips_elec.recommendations.television.0"),
    ...
    headphones: [
      t("tips_elec.recommendations.headphones.0"),
    ...
    camera: [
      t("tips_elec.recommendations.camera.0"),
    ...
    console: [
      t("tips_elec.recommendations.console.0"),
    ...
    smartwatch: [
      t("tips_elec.recommendations.smartwatch.0"),
    ...
    router: [
      t("tips_elec.recommendations.router.0"),
