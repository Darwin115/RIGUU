...
function Tips_Elec({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.label}>Tipo de aparato electrónico</Text>
      <TextInput
        style={styles.input}
        placeholder="Escribe el tipo de aparato electrónico"
        value={input1}
        onChangeText={setInput1}
      />
      
      {/* Título y segundo campo de texto */}
      <Text style={styles.label}>Estado del aparato</Text>
      <TextInput
        style={styles.input}
        placeholder="Escribe el estado del aparato"
        value={input2}
